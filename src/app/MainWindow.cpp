...
void MainWindow::updatePropertyTable(const QString& itemType,
    ...
    connect(bundlePolicyCombo, &QComboBox::currentTextChanged, this, [this](const QString& text) {
        ...
        const EdgeBundlePolicy policy =
            (text == QStringLiteral("Directional")) ? EdgeBundlePolicy::Directional : EdgeBundlePolicy::Centered;
    ...
    connect(bundleSpacingSpin, qOverload<int>(&QSpinBox::valueChanged), this, [this](int value) {
        ...
        m_scene->setEdgeBundleSpacing(static_cast<qreal>(value));
    });
